...
import com.ambev.pratico2.models.Cerveja;
...
public class ProdutoControllerTest {
    ...
    public void testCadastrarProdutoEVerificarCadastro() throws Exception {
        ...
        Produto produtoCerveja = produtoRepository.findByDescricao("Cerveja de teste").get(0);
        assert produtoCerveja != null;
        assert produtoCerveja.getDescricao().equals("Cerveja de teste");
    }
